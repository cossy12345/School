  ...
  return (
    <>
      <div className="bg-neutral-800/10 shadow-xl rounded-lg w-full h-auto mt-6">
        ...
        <p>Hi! I'm <strong>Cosmas</strong>, a 39-year-old software developer and content creator based in Nigeria, imala. Originally from Mbaise, Imo State, I specialize in technology, software, and content creation.</p>
        <br></br>
        ...
        <ul>
            <li><a href="https://facebook.com/umutxyp" target="_blank">* Nwagwu.cosmas.1- Facebook</a></li>
            <li><a href="https://instagram.com/umutxyp" target="_blank">* cosmas - Instagram</a></li>
            <li><a href="https://t.me/umutland" target="_blank">* cosmas - Telegram</a></li>
            <li><a href="https://youtube.com/umutxyp" target="_blank">* cosmas - YouTube</a></li>
        </ul>
<br></br>
...
<br></br>
        ...
        <p>If you're interested in learning more about software, crypto, or community management, let’s connect on my social media channels! 😊</p>
              ...
              <div className={`order-first lg:order-last flex-shrink-0 relative w-[160px] h-[160px] rounded-full pulse-avatar-online `}>
                <img alt="cosmas" src={`https://ugc.production.linktr.ee/6RJk9s2pQZ2yAdcxw3Ir_TXX2dLlNmwM2OFdf?io=true&size=avatar-v3_0`} width="160" height="160" className={`bg-neutral-700 w-[160px] h-[160px] rounded-full`} />
              </div>
